...
extern "C" {
#endif
SWIGINTERN const char *_wrap_FmIndex_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&FmIndex), SWIGTYPE_p_class, 0 );
  if (value) {
...
SWIGINTERN const char *_wrap_FmIndex_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(value, &argp, SWIGTYPE_p_class,  0 );
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""FmIndex""' of type '""class""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""FmIndex""' of type '""class""'");
    } else {
      FmIndex = *((class *)(argp));
    }
  }
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "FmIndex", 0, (swig_variable_func) _wrap_FmIndex_get,(swig_variable_func) _wrap_FmIndex_set},
    {0,0,0,0}
};
